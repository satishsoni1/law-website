    ...
    <div class="container">
        ...
        <div class="row g-4 mt-2">
            @foreach([
                ...
                ['photo'=>'storage/faculty/0ERGhG1iBRIoZXiA6lr7kCkHlPbv7F0aZwfmy6yb.jpg','name'=>'Principal','role'=>'Principal, K.T.S.P.M\'s Law College','route'=>'mandal.principal','icon'=>'fa-balance-scale','color'=>'#2d6a4f','msg'=>'Welcome to K.T.S.P.M\'s Law College, Khopoli. Our mission is to produce not just lawyers, but legal professionals who are ethical, articulate, and committed to justice. We provide a holistic environment where students can grow academically and professionally.'],
            ] as $leader)
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center gap-3 mb-3">
                            <div style="width:55px;height:55px;background:{{ $leader['color'] }}15;border-radius:50%;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
                                <img src="{{ $leader['photo'] }}" alt="{{ $leader['name'] }}" style="width:32px;height:32px;border-radius:50%;object-fit:cover;">
                            </div>
                            <div>
